  ...
  var db = firebase.firestore();
    ...
    db.collection("users").onSnapshot((querySnapshot) => {
        ...
        querySnapshot.forEach((doc) => {
            ...
            <td><button class="btn btn-warning" onclick="editar('${doc.id}','${doc.data().photo}','${doc.data().email}','${doc.data().nombre}','${doc.data().empresa}','${doc.data().empresa}','${doc.data().motivo}','${doc.data().visitado}','${doc.data().date}')">Editar</button></td>
          </tr>`
        });
    });
